...
CREATE TABLE tipo_transaccion (id SERIAL PRIMARY KEY, nombre VARCHAR(64) NOT NULL UNIQUE);
...
CREATE TABLE transaccion (id SERIAL PRIMARY KEY, id_tipo_transaccion INT REFERENCES tipo_transaccion(id), id_inventario INT REFERENCES inventario(id), fecha DATE NOT NULL DEFAULT NOW());
